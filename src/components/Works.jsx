  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Below is a summary of the projects I have done, with tools used to
          leverage the project. DevOps projects are not included below but
          Development only. Each card define tools used to power the project,
          challenges that propelled the project, steps taken to achieve the
